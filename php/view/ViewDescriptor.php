...
class ViewDescriptor {
     ...
     * amministratore, organizzatore e partecipante, corrispondenti alle sottocartelle 
     ...
     * un amministratore possa impersonare un organizzatore o un partecipante
     * @param string $token
     */
     ...
     * quando si accede all'interfaccia dell'organizzatore o del partecipante 
